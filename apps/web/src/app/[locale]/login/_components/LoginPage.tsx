  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (result?.error) {
        ...
        // The useEffect above handles redirect based on user_type
        // For immediate redirect, we check the session via a refetch
        // The useEffect will fire once session updates
      }
    } catch {
      setError(t('loginError'));
    } finally {
