                  ...
                  >
                    ...
                    {proposal.status === 'accepted' && !course.is_completed && (
                      <button
                        ...
                        className="px-3 py-1.5 text-xs font-medium bg-pastelgreen-100 text-pastelgreen-600 rounded-lg hover:bg-pastelgreen-500 hover:text-white transition-colors cursor-pointer shrink-0 ml-2"
                      >
                        {t('actions.markCompleted' as Parameters<typeof t>[0])}
                      </button>
                    )}
                  </div>
                ))}
